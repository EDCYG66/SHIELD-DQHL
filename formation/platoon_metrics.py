...
class PlatoonMetricsTracker:
    ...
    def update(self, *, step: int, state_fields: Dict[str, float], info: Dict[str, float], action: str, reward: float) -> None:
        row = {
            ...
            "action_eco_keep": 1.0 if action == "eco_keep" else 0.0,
            "action_gap_recover": 1.0 if action == "gap_recover" else 0.0,
    ...
    def summary(self) -> Dict[str, float]:
        ...
        return {
            ...
            "avg_reward_safety": avg("reward_safety"),
            "avg_reward_platoon": avg("reward_platoon"),
            "avg_reward_communication": avg("reward_communication"),
            "avg_reward_efficiency": avg("reward_efficiency"),
            "avg_reward_energy_speed": avg("reward_energy_speed"),
            "avg_reward_action_appropriateness": avg("reward_action_appropriateness"),
            ...
            "avg_action_eco_keep": avg("action_eco_keep"),
            "avg_action_gap_recover": avg("action_gap_recover"),
