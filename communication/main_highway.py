...
# Reduce TensorFlow C++ info/debug log noise when training from this entry.
...
ap.add_argument('--gnn-type', type=str, default='gat', choices=['gat', 'gatclassic', 'sage', 'fc'])
ap.add_argument('--run-dir', type=str, default=None, help='optional output directory for csv/figures/weights')
# Vehicles & topology
